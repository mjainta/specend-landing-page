            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="text-center pb-12 md:pb-16">
                <div className="max-w-3xl mx-auto">
                  <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">You have successfully subscribed. We will contact you as soon as we have additional information about Spec-End and your options to contribute.</p>
