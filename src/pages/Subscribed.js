            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="text-center pb-12 md:pb-16">
                <div className="max-w-3xl mx-auto">
                  <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">You have successfully registered. We will contact you soon about options to contribute and your alpha access.</p>
