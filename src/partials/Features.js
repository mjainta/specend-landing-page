...
function Features() {
  ...
  return (
    <section className="relative">
      ...
      <div id="learnMore" className="relative max-w-6xl mx-auto px-4 sm:px-6">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Track the value of your inventory or collection on a daily basis, for any collectible.</div>
                  </div>
